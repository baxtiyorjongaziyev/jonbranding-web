...
const KnobToggle = ({ isOn, onToggle }: { isOn: boolean; onToggle: (value: boolean) => void }) => {
  ...
  return (
    <motion.div
      ...
      tabIndex={0}
      className={cn(
        "w-12 h-8 flex items-center p-1 rounded-full cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
