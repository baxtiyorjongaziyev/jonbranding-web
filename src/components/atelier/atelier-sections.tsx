...
export const ATGallery: FC<ATGalleryProps> = ({ dictionary, onOpen, lang }) => {
  ...
  const all = [
    ...
    {
      cls: 't-2',
      img: 'https://cdn.sanity.io/images/h6ymmj0v/production/f4763a990390239063c4cb13fa0f3d4b1446b9e0-2560x1440.jpg',
      name: 'Incontrol',
      yr: '2024',
      city:
        lang === 'uz'
    ...
    {
      cls: 't-3',
      img: 'https://cdn.sanity.io/images/h6ymmj0v/production/c02f0468758f0231648b33324f08f7fa8d74ef8d-608x614.png',
      name: 'Barakah',
      yr: '2025',
      city:
        lang === 'uz'
    ...
    {
      cls: 't-4',
      img: '/images/cms/boyarin-hozir.png',
      name: 'Boyarin',
      yr: '2024',
      city:
        lang === 'uz' ? 'Buxoro' : lang === 'ru' ? 'Бухара' : lang === 'zh' ? '布哈拉' : 'Bukhara',
      cat: 'Qadoq · 12 SKU',
      res: '+31% sotuv',
      dark: true,
      ind: 'fmcg',
    ...
    {
      cls: 't-5',
      img: 'https://cdn.sanity.io/images/h6ymmj0v/production/ad4e5b4a2b5e1044accc01c93ab3b837a7b6c408-2570x1729.png',
      name: 'Nur Sopol',
      yr: '2023',
      city:
        lang === 'uz' ? 'Rishton' : lang === 'ru' ? 'Риштан' : lang === 'zh' ? '里什坦' : 'Rishtan',
      cat: 'Aydentika',
      res: "2× ko'rinish",
      dark: false,
      ind: 'fmcg',
    ...
    {
      cls: 't-6',
      img: '/images/cms/fidda-hozir.png',
      name: 'Fidda',
      yr: '2023',
      city:
        lang === 'uz'
          ...
          <div className="lede">
            ...
            <p>
              {dictionary?.gallery_lede ||
                '2023—2025 davrida tanlangan 6 ta loyiha. Har biri real biznes, real qadoq, real natija. Sohaga qarab filterlang.'}
            </p>
          </div>
        </div>
          ...
          <p
            dangerouslySetInnerHTML={{
              __html:
                ...
                "Har bir gap real biznes egasidan, real loyiha haqida. <strong>Yolg'on yoki bo'rttirma yo'q</strong> — tekshirishingiz mumkin.",
            }}
          />
        </div>
      </div>
                ...
                {t.image ? (
                  ...
                  <div
                    style={{
                      position: 'absolute',
                      inset: 0,
                      background: 'linear-gradient(135deg, #1B4DFF20, #C2552A20)',
                    }}
                  />
                )}
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      'linear-gradient(to top, rgba(14,16,21,0.95), rgba(14,16,21,0.2) 60%, transparent)',
                  }}
                />
          ...
          >
            ...
            <div
              style={{
                ...
                zIndex: 2,
                background:
                  'linear-gradient(to top, rgba(14,16,21,0.95), rgba(14,16,21,0.4) 60%, transparent)',
                padding: 24,
                color: '#FFF',
              }}
            >
