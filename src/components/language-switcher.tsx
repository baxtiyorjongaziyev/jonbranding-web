  ...
  if (!mounted) {
    return (
      <Button
        variant="ghost"
        className={cn(
            "w-auto justify-start gap-2 font-semibold !shadow-none rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2",
            triggerTone
        )}
    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
          <Button
            ...
            className={cn(
                "w-auto justify-start gap-2 font-semibold !shadow-none focus:!outline-none rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2",
                triggerTone
            )}
            style={{ border: 'none', boxShadow: 'none' }}
