...
const Footer: FC<{ lang: string, dictionary: Dictionary }> = ({ lang = 'uz', dictionary }) => {
  ...
  return (
    <footer className="relative overflow-hidden rounded-t-[5rem] bg-black text-white sm:rounded-t-[6rem] md:rounded-t-[8rem] lg:rounded-t-[10rem]" suppressHydrationWarning>
