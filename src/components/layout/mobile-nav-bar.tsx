  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 px-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] md:hidden">
      <nav
        ...
        className="mx-auto flex max-w-[420px] items-center justify-between gap-1.5 overflow-hidden rounded-[24px] border border-white/70 bg-white/[0.92] p-1.5 shadow-[0_20px_70px_-30px_rgba(15,23,42,0.65)] backdrop-blur-xl"
      >
            <a
              href="tel:+998336450097"
              aria-label={labels.call}
              className="flex min-w-0 flex-1 flex-col items-center justify-center rounded-[18px] px-2 py-2 text-slate-600 transition-[color,background-color,transform] duration-200 hover:bg-slate-100 hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 active:scale-[0.96]"
            >
            ...
            <a
              ...
              className="flex min-w-0 flex-1 flex-col items-center justify-center rounded-[18px] px-2 py-2 text-slate-600 transition-[color,background-color,transform] duration-200 hover:bg-sky-50 hover:text-[#0088cc] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 active:scale-[0.96]"
            >
            ...
            <button
              ...
              className="flex min-w-0 flex-1 flex-col items-center justify-center rounded-[18px] px-2 py-2 text-slate-600 transition-[color,background-color,transform] duration-200 hover:bg-blue-50 hover:text-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 active:scale-[0.96]"
            >
            ...
            <button
              ...
              className={cn(
                'group relative flex min-w-[136px] flex-[1.85] items-center justify-center gap-2 overflow-hidden rounded-[20px] bg-slate-950 px-3 py-3 text-white shadow-[0_14px_34px_-18px_rgba(15,23,42,0.9)]',
