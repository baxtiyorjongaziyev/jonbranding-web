...
const CASES = [
  { name: 'ARFADEL', city: 'Toshkent', year: '2026', image: '/images/cms/arfadel-cover.webp', color: '#1A1210' },
  { name: 'Beyaz', city: 'Toshkent', year: '2026', image: '/images/cms/beyaz-gold.webp', color: '#2C3A2A' },
  { name: 'Boyarin', city: 'Toshkent', year: '2026', image: '/images/cms/boyarin-hozir.webp', color: '#0A1C3A' },
  { name: 'Enros', city: 'Toshkent', year: '2025', image: '/images/cms/enros-cover.webp', color: '#0D0D1A' },
];
