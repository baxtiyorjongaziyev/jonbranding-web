...
export default function AtStickyCta({ onOpen }: Props) {
  ...
  // Optimization: useMotionValueEvent runs on an optimized requestAnimationFrame loop
  // instead of synchronously on every main-thread event, significantly reducing jank
  // and performance overhead during rapid scrolling.
