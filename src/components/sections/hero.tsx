  ...
  return (
    <section className="relative isolate overflow-hidden bg-white text-foreground" onMouseMove={onMouseMove}>
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 transition-opacity duration-500" style={{ background: `radial-gradient(700px circle at ${spot.x}% ${spot.y}%, hsl(222 42% 28% / 0.06), transparent 55%)` }} />
      </div>
