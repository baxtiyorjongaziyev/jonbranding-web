          ...
          >
            {translations.proofCards.map((card, i) => {
              ...
              return (
                <div
                  key={card.label}
                  className="rounded-2xl border border-neutral-800/60 bg-neutral-900/30 backdrop-blur-sm px-5 py-4 transition-[background-color,border-color] duration-300 motion-reduce:transition-none hover:border-[var(--at-accent)]/20 hover:bg-neutral-900/50"
                >
