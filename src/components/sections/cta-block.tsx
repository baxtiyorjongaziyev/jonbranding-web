  ...
  return (
    <section className="bg-brand-paper py-16">
      <div className="container mx-auto px-4">
        <div className="relative isolate overflow-hidden rounded-[2.5rem] sm:rounded-[3rem] md:rounded-[3.5rem] lg:rounded-[4rem] border border-white/10 bg-[#070b12] px-6 py-12 shadow-[0_40px_100px_-45px_rgba(15,23,42,0.7)] sm:px-10 sm:py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <h2 className="max-w-4xl text-balance text-3xl font-black tracking-normal text-white sm:text-5xl">{title}</h2>
