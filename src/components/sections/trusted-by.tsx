...
const TrustedBy: React.FC<{ lang: string; dictionary: any; brands?: Brand[] }> = ({ lang, dictionary, brands: brandsProp }) => {
    const brands = (brandsProp && brandsProp.length > 0 ? brandsProp : staticBrands).filter(b => !b.hiddenInHero);
