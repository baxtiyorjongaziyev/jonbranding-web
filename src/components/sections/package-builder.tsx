...
const ServiceCard = ({ id, onSelect, selected, lang, dictionary, currency }: { id: keyof SelectedServices, onSelect: () => void, selected: boolean, lang: any, dictionary: any, currency: any }) => {
        ...
        >
            <CardHeader className="p-6 pb-4">
                <div className="flex justify-between items-start mb-4">
                    ...
                    {isVip && (
                        <div className="bg-amber-400 text-black text-[10px] font-bold px-2 py-1 rounded-full uppercase flex items-center gap-1">
            ...
            <CardContent className="p-6 pt-0 flex-grow flex flex-col">
                ...
                <div className="mt-8 space-y-4">
                    <div className="space-y-2 text-[11px] min-h-[60px] flex flex-col justify-end">
                        ...
                        {timeline && (
                            <div className="flex items-center gap-2 font-medium text-slate-400 uppercase">
                ...
                <div className="space-y-20">
                    <ServiceGroup title={translations.categories.tripwire}>
                        {['namingCheck', 'audit', 'consultation'].map((id) => (
                            <ServiceCard key={id} id={id as any} selected={selectedServices[id as any]} onSelect={() => handleServiceToggle(id as any)} lang={lang} dictionary={translations} currency={currency} />
                        ))}
                    </ServiceGroup>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {Object.values(selectedServices).every(v => !v) && (
                                        <p className="text-slate-500 italic py-4">{translations.empty_package_desc}</p>
                                    )}
                                </div>
                            </div>
