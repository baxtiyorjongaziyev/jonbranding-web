...
import { Clock, PercentSquare, Sparkles, Rocket, ShieldCheck, FileCheck, Gift, LifeBuoy, BadgePercent, ArrowRight } from 'lucide-react';
...
const Offer: FC<OfferProps> = ({ onCTAClick, lang, dictionary }) => {
    ...
    useEffect(() => {
        const initialSlots = parseInt(localStorage.getItem('slotsLeft') || '5');
    ...
    return (
        <section id="offer" className="relative bg-dark-blue text-white overflow-hidden">
