          ...
          <div className="relative z-10">
            <CardHeader className="text-center p-0 mb-8">
              <div className="flex justify-center items-center gap-2 mb-2">
                ...
                <p className="font-bold text-accent uppercase tracking-widest">
                        ...
                        <Tooltip key={index}>
                          <TooltipTrigger asChild>
                            ...
                            >
                              ...
                              {isNext && (
                                <div className="absolute -top-1 -right-1 h-3 w-3 rounded-full bg-accent ring-2 ring-background"></div>
                              )}
                            </div>
                          </TooltipTrigger>
                          <TooltipContent>
