...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const canonicalUrl = `https://www.jonbranding.uz/${lang === 'uz' ? '' : lang + '/'}xizmatlar/neyming`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'uz': 'https://www.jonbranding.uz/xizmatlar/neyming',
        'ru': 'https://www.jonbranding.uz/ru/xizmatlar/neyming',
        'en': 'https://www.jonbranding.uz/en/xizmatlar/neyming',
        'zh': 'https://www.jonbranding.uz/zh/xizmatlar/neyming',
      },
    },
  };
}
