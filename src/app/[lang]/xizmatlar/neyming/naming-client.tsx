                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <div>
                        ...
                        <div className="mt-4 space-y-4 text-lg text-gray-700">
                            ...
                            <p>{translations.section1_p2 || (lang === 'uz' ? "Biz neymingni shunchayi ijodiy jarayon deb emas, balki brend strategiyasining ajralmas qismi deb bilamiz." : "We see naming not just as a creative process, but as an integral part of brand strategy.")}</p>
                        </div>
                    </div>
