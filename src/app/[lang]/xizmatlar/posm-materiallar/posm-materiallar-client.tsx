...
const includedIcons = [Sparkles, Tag, Printer, Layers, Megaphone, Paintbrush, FileCheck2, Wrench];
const benefitIcons = [Eye, BadgeCheck, TrendingUp, ShoppingBag, ClipboardCheck, Star, Sparkles, CheckCircle2];
...
function HeroSection({ t }: { t: PosmPageTranslations }) {
  return (
    <section className="border-b border-slate-200 bg-white py-14 sm:py-20">
      <div className="container mx-auto max-w-5xl px-4 text-center">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          >
            <Link href="#posm-tariffs">{t.hero.secondaryCta}</Link>
          </Button>
        </div>
      </div>
    </section>
...
function PricingSection({ pricing, primaryCta }: { pricing: PosmPageTranslations['pricing']; primaryCta: string }) {
  return (
    <section id="posm-tariffs" className="scroll-mt-24 py-16 sm:py-20">
...
function IncludedSection({ included }: { included: PosmPageTranslations['included'] }) {
  return (
...
function BenefitsAudienceSection({
  ...
  benefits: PosmPageTranslations['benefits'];
  audience: PosmPageTranslations['audience'];
}) {
  return (
    <section className="border-y border-slate-200 bg-white py-16 sm:py-20">
...
function ProcessSection({ process }: { process: PosmPageTranslations['process'] }) {
  return (
...
function FinalCta({ cta }: { cta: PosmPageTranslations['cta'] }) {
  return (
...
function FaqSection({ faq }: { faq: PosmPageTranslations['faq'] }) {
  return (
...
export default PosmMateriallarClient;
