...
const APP_NAME = "Xizmatlar va Narxlar | Jon.Branding";
const APP_DESCRIPTION = "Bizning barcha xizmatlarimiz bilan tanishing va o'zingizga mos bo'lgan brending to'plamini yarating. Onlayn kalkulyator yordamida narxlarni darhol hisoblang.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: APP_NAME,
    description: APP_DESCRIPTION,
    url: 'https://jonbranding.uz/xizmatlar',
  ...
  alternates: {
    canonical: 'https://jonbranding.uz/xizmatlar',
  },
};
