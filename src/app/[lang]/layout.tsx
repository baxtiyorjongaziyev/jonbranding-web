  ...
  return (
    <html lang={lang} className={`${hankenGrotesk.variable} ${instrumentSerif.variable} ${jetbrainsMono.variable} ${interTight.variable}`} suppressHydrationWarning>
      <head>
        ...
        />
        {/* FAQPage bu yerda yo'q: savollar faqat FAQ ko'rinadigan sahifalarda (bosh sahifa) beriladi.
            AggregateRating olib tashlandi: o'z saytidagi o'z-o'ziga reyting Google qoidalariga zid. */}
        <Script
          id="json-ld-person"
          type="application/ld+json"
          dangerouslySetInnerHTML={{
