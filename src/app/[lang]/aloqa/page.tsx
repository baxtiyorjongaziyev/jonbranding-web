...
const metaByLang: Record<Locale, { title: string; description: string }> = {
  uz: {
    ...
    description: 'Jon.Branding bilan bog\'laning: +998 79 200 00 97, Telegram, Instagram. Online brifing, brend tashxisi va konsultatsiya. 6 yillik tajriba, 240+ loyiha.',
  },
  ru: {
    title: 'Контакты — Jon.Branding | Брендинговое агентство Ташкент',
    description: 'Свяжитесь с Jon.Branding — Телефон: +998 79 200 00 97, Telegram, Instagram. Онлайн брифинг, бренд-диагностика и консультация. 6 лет опыта, 240+ проектов.',
  },
  en: {
    title: 'Contact — Jon.Branding | Branding Agency Tashkent',
    description: 'Contact Jon.Branding — Phone: +998 79 200 00 97, Telegram, Instagram. Online briefing, brand audit and consultation. 6 years of experience, 240+ projects.',
  },
  zh: {
    title: '联系我们 — Jon.Branding | 塔什干品牌机构',
    description: '联系 Jon.Branding — 电话：+998 79 200 00 97，Telegram，Instagram。提供在线简报、品牌诊断和咨询。6年经验，240+项目。',
  },
};
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: m.title,
      description: m.description,
      url: getLocalizedAbsoluteUrl(BASE_URL, safeLang, '/aloqa'),
