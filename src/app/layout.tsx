...
export function generateMetadata({ params: { lang } }: { params: { lang: Locale } }): Metadata {
  ...
  return {
    ...
    icons: {
      icon: 'https://img2.teletype.in/files/92/3c/923cd394-a437-47e1-86a1-51e1a2a3eb38.png',
      shortcut: 'https://img2.teletype.in/files/92/3c/923cd394-a437-47e1-86a1-51e1a2a3eb38.png',
      apple: 'https://img2.teletype.in/files/92/3c/923cd394-a437-47e1-86a1-51e1a2a3eb38.png',
    },
    openGraph: {
      title,
      description,
