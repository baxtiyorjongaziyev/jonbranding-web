...
const zhServiceDetails = {
    ...
    logoVIP: { ...uzServiceDetails.logoVIP, label: "标志 + 企业形象 + 品牌手册", description: "扩展的形象和全面支持。", features: ["巴赫蒂约尔洪·加济耶夫亲自参与和监督", "基于品牌策略开发8个以上标志概念", "竞争对手和行业的广泛视觉分析", "25个以上接触点设计（线下和线上）", "视觉品牌手册：颜色、字体、标志使用规则、网格、迷你指南", "标志手册（PDF + 印刷版）", "30个Telegram贴纸 + 20个图标", "标志动画（高级质量）", "协助专利申请（费用另计）", "交付后长达3个月的支持"], timeline: "初步概念在20-30个工作日内提交" },
