...
const uzServiceDetails = {
    ...
    namingMax: { label: "Neyming Max", description: "Katta va xalqaro bozorga mo'ljallangan loyihalar uchun.", price: 17875000, timeline: "3-4 hafta", note: null, features: ["20+ nom varianti", "To'liq strategik neyming", "Xalqaro bazalarda tekshiruv", "Slogan (shior) ishlab chiqish", "Falsafiy ma'no"] },
    ...
    logoPro: { label: "Logo va firma uslubi", description: "O'z brendini jiddiy rivojlantirish niyatidagilar uchun.", price: 19552500, timeline: "2-4 hafta", note: null, features: ["2 ta konsepsiya", "To'liq firma uslubi (rang, shrift)", "5 ta nositelda namoyish", "Brend-falsafasi", "Brendbuk Light versiya"], recommended: true },
    logoMax: { label: "To'liq dizayn-tizim", description: "<strong>Logotipni o'z ichiga oladi.</strong> Yirik brendlar uchun.", price: 37115000, timeline: "4-6 hafta", note: null, features: ["3+ konsepsiya", "Kengaytirilgan firma uslubi", "Ikonikalar va piktogrammalar", "Brend patternlari", "To'liq Brendbuk"] },
...
const ruServiceDetails = {
    ...
    namingMax: { label: "Нейминг Макс", description: "Для крупных и международных проектов.", price: 17875000, timeline: "3-4 недели", note: null, features: ["20+ вариантов имени", "Полный стратегический нейминг", "Международная проверка", "Разработка слогана", "Философский смысл"] },
    ...
    logoPro: { label: "Логотип и фирменный стиль", description: "Для тех, кто серьезно настроен развивать свой бренд.", price: 19552500, timeline: "2-4 недели", note: null, features: ["2 концепции", "Полный фирменный стиль (цвет, шрифт)", "Демонстрация на 5 носителях", "Философия бренда", "Брендбук Light версия"], recommended: true },
    logoMax: { label: "Полная дизайн-система", description: "<strong>Включает логотип.</strong> Для крупных брендов.", price: 37115000, timeline: "4-6 недель", note: null, features: ["3+ концепции", "Расширенный фирменный стиль", "Иконки и пиктограммы", "Фирменные паттерны", "Полный Брендбук"] },
...
const enServiceDetails = {
    ...
    namingMax: { label: "Naming Max", description: "For large and international projects.", price: 17875000, timeline: "3-4 weeks", note: null, features: ["20+ name options", "Full strategic naming", "International database check", "Slogan development", "Philosophical meaning"] },
    ...
    logoPro: { label: "Logo & Corporate Identity", description: "For those serious about developing their brand.", price: 19552500, timeline: "2-4 weeks", note: null, features: ["2 concepts", "Full corporate identity (color, font)", "5 mockups", "Brand philosophy", "Brandbook Light version"], recommended: true },
    logoMax: { label: "Full Design System", description: "<strong>Includes logo.</strong> For major brands.", price: 37115000, timeline: "4-6 weeks", note: null, features: ["3+ concepts", "Expanded corporate identity", "Icons and pictograms", "Brand patterns", "Full Brandbook"] },
