...
const uzServiceDetails = {
    ...
    namingStandard: { label: "Naming Standard", description: "Kichik biznes uchun ideal.", price: 8200000, note: null, features: ["Kompaniya va soha qisqa o‘rganiladi", "Raqobatchilar umumiy ko‘rib chiqiladi", "Mijoz xohish-istaklari yig‘iladi", "3 ta nom varianti ishlab chiqiladi", "Domen va ijtimoiy tarmoqlarda bo‘shlik tekshiriladi", "Patent bo‘yicha 1 klass auditi qilinadi", "Har bir variant fonetik jihatdan tekshiriladi", "Birinchi konsepsiyalar 7–10 ish kuni ichida taqdim etiladi"] },
    namingPremium: { label: "Naming Premium", description: "O'rta va rivojlanayotgan biznes uchun.", price: convertToUzs(1000), note: null, features: ["Kompaniya va soha chuqurroq o‘rganiladi", "Raqobatchilar va bozor tahlili qilinadi", "10+ nom varianti ishlab chiqiladi", "Domen va ijtimoiy tarmoqlarda bo‘shlik tekshiriladi", "6 tilda semantik va fonetik tekshiruv (Ingliz, Rus, Turk, Ispan, Italyan, Fransuz)", "Patent bo‘yicha 2 klass auditi va huquqiy xulosa", "5 yilga domen band qilib beriladi", "Nom variantlari qisqa taqdimot shaklida ko‘rsatiladi", "Birinchi konsepsiyalar 14–20 ish kuni ichida taqdim etiladi"], recommended: true },
    namingVIP: { label: "Naming VIP", description: "Katta va xalqaro bozorga mo'ljallangan loyihalar uchun.", price: 17875000, note: null, features: ["Kompaniya, soha va auditoriya chuqur tahlil qilinadi", "Raqobatchilar va bozorning keng qamrovli tahlili qilinadi", "20+ keng konsepsiyali nom variantlari ishlab chiqiladi", "Domen va ijtimoiy tarmoqlarda bo‘shlik tekshiriladi", "6 tilda semantik + fonetik + huquqiy tekshiruv", "Patent tezlashtirilgan topshiruv (boj alohida)", "10 yilga domen band qilib beriladi", "Har bir nom uchun storytelling asosida tushuntirish beriladi", "Taqdimot professional prezentatsiya formatida qilinadi", "3 oygacha post-delivery huquqiy maslahat va kuzatuv", "Birinchi konsepsiyalar 20–25 ish kuni ichida taqdim etiladi"] },
    logoStandard: { label: "Logotip Standard", description: "Startaplar uchun tezkor yechim.", price: 9900000, note: null, features: ["Kompaniya brifi asosida 3 ta logotip konsepsiyasi ishlab chiqiladi", "Raqobatchilar logotiplari tahlil qilinadi", "5 ta touchpoint vizualizatsiya (vizitka, post, web, qadoq, signage)", "Logotip vektor fayllari (AI, EPS, PNG, JPG, PDF) taqdim qilinadi", "Har bir konsepsiya texnik va vizual standartlarga tekshiriladi", "Birinchi konsepsiyalar 7–10 ish kuni ichida taqdim etiladi"] },
    logoPremium: { label: "Logotip Premium", description: "O'z brendini jiddiy rivojlantirish niyatidagilar uchun.", price: 19552500, note: null, features: ["Kompaniya qadriyatlari va strategiyasiga mos 5 ta logotip konsepsiyasi ishlab chiqiladi", "Raqobatchilar va bozor vizual identifikatsiyasi o‘rganiladi", "15+ touchpoint vizualizatsiya (vizitka, qadoq, reklama, web, social post)", "Firma uslubi (asosiy ranglar, shriftlar, logotip qo‘llash qoidalari) ishlab chiqiladi", "10 ta Telegram stiker tayyorlanadi", "Taqdimot professional maketlar bilan ko‘rsatiladi", "Birinchi konsepsiyalar 14–20 ish kuni ichida taqdim etiladi"], recommended: true },
    logoVIP: { label: "Logotip VIP", description: "Kengaytirilgan identifikatsiya va to'liq qo'llab-quvvatlash.", price: 37115000, note: null, features: ["Brend strategiyasi asosida 8+ logotip konsepsiyasi ishlab chiqiladi", "Raqobatchilar va soha bo‘yicha keng vizual tahlil qilinadi", "25+ touchpoint dizayn (offline va online)", "Vizual Brandbook: ranglar, shriftlar, logotip qo‘llash qoidalari, grid, minimal qo‘llanma", "Logobook (PDF + print-ready)", "30 ta Telegram stiker + 20 ikon", "Logotip animatsiyasi (premium sifatli)", "Patent topshiruv jarayonida hamrohlik (boj alohida)", "3 oygacha post-delivery qo‘llab-quvvatlash", "Birinchi konsepsiyalar 20–30 ish kuni ichida taqdim etiladi"] },
    brandbook: { label: "Brendbuk va gaydlayn", description: "Firma uslubidan foydalanish bo'yicha qoidalar hujjati.", price: convertToUzs(1000), note: null, features: ["Logotipdan foydalanish qoidalari", "Ranglar va shriftlar tizimi", "Dizayn maketlari namunalari", "Taqiqlangan holatlar"] },
...
const enServiceDetails = {
    ...
    namingStandard: { label: "Naming Standard", description: "Ideal for small businesses.", price: 8200000, note: null, features: ["Brief study of the company and industry", "General overview of competitors", "Collection of client's wishes", "Development of 3 name variants", "Domain and social media availability check", "Patent audit for 1 class", "Phonetic check of each variant", "First concepts are presented within 7–10 working days"] },
    namingPremium: { label: "Naming Premium", description: "For medium and growing businesses.", price: convertToUzs(1000), note: null, features: ["Deeper study of the company and industry", "Analysis of competitors and market", "Development of 10+ name variants", "Domain and social media availability check", "Semantic and phonetic check in 6 languages (English, Russian, Turkish, Spanish, Italian, French)", "Patent audit for 2 classes and legal opinion", "5-year domain reservation", "Name variants are presented in a short presentation format", "First concepts are presented within 14–20 working days"], recommended: true },
    namingVIP: { label: "Naming VIP", description: "For large and international projects.", price: 17875000, note: null, features: ["In-depth analysis of the company, industry, and audience", "Comprehensive analysis of competitors and market", "Development of 20+ name variants with broad concepts", "Domain and social media availability check", "Semantic + phonetic + legal check in 6 languages", "Expedited patent filing (fee separate)", "10-year domain reservation", "Storytelling-based explanation for each name", "Presentation in a professional format", "Up to 3 months of post-delivery legal advice and monitoring", "First concepts are presented within 20–25 working days"] },
    logoStandard: { label: "Logo Standard", description: "A quick solution for startups.", price: 9900000, note: null, features: ["Development of 3 logo concepts based on the company brief", "Analysis of competitors' logos", "5 touchpoint visualizations (business card, post, web, packaging, signage)", "Provision of logo vector files (AI, EPS, PNG, JPG, PDF)", "Check of each concept for technical and visual standards", "First concepts are presented within 7–10 working days"] },
    logoPremium: { label: "Logo Premium", description: "For those serious about developing their brand.", price: 19552500, note: null, features: ["Development of 5 logo concepts matching the company's values and strategy", "Study of competitors' and market's visual identity", "15+ touchpoint visualizations (business card, packaging, advertising, web, social post)", "Development of corporate identity (main colors, fonts, logo usage rules)", "Creation of 10 Telegram stickers", "Presentation with professional mockups", "First concepts are presented within 14–20 working days"], recommended: true },
    logoVIP: { label: "Logo VIP", description: "Expanded identity and full support.", price: 37115000, note: null, features: ["Development of 8+ logo concepts based on brand strategy", "Broad visual analysis of competitors and industry", "25+ touchpoint designs (offline and online)", "Visual Brandbook: colors, fonts, logo usage rules, grid, mini-guide", "Logobook (PDF + print-ready)", "30 Telegram stickers + 20 icons", "Logo animation (premium quality)", "Assistance with patent filing (fee separate)", "Up to 3 months of post-delivery support", "First concepts are presented within 20–30 working days"] },
    brandbook: { label: "Brandbook and Guideline", description: "A document with rules for using the corporate identity.", price: convertToUzs(1000), note: null, features: ["Logo usage rules", "Color and font system", "Design layout examples", "Prohibited cases"] },
