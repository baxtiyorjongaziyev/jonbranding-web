    ...
    return {
        ...
        namingVIP: {
            ...
            features: isUz ? [
                ...
                "10 вариантов названий", "Стратегическое обоснование", "Проверка произношения", "Проверка доменов", "Проверка соцсетей", "Патентная проверка", "Анализ конкурентов", "Лингвистический анализ (6 языков)", "Анализ эмоций", "3 варианты слоганов", "Подача на патент", "Сертификат владения", "Безлимитные правки (30 дней)"
            ] : (isZh ? [
