...
const uzServiceDetails = {
    ...
    namingStandard: { label: "Naming Standard", description: "Kichik biznes uchun ideal.", price: 8200000, note: null, features: ["Kompaniya va soha qisqa o‘rganiladi", "Raqobatchilar umumiy ko‘rib chiqiladi", "Mijoz xohish-istaklari yig‘iladi", "2 ta nom varianti ishlab chiqiladi", "Domen va ijtimoiy tarmoqlarda bo‘shlik tekshiriladi", "Patent bo‘yicha 1 klass auditi qilinadi", "Har bir variant fonetik jihatdan tekshiriladi"], timeline: "Birinchi konsepsiyalar 7–10 ish kuni ichida taqdim etiladi" },
...
const enServiceDetails = {
    ...
    namingStandard: { label: "Naming Standard", description: "Ideal for small businesses.", price: 8200000, note: null, features: ["Brief study of the company and industry", "General overview of competitors", "Collection of client's wishes", "Development of 2 name variants", "Domain and social media availability check", "Patent audit for 1 class", "Phonetic check of each variant"], timeline: "First concepts are presented within 7–10 working days" },
