    ...
    items: [
      {
        ...
        name: '品牌战略',
        price: '48 000 000',
        lead: '厘清您的品牌应在市场中占据的位置。服务谁、以何取胜、说什么——统一为一套战略体系。',
        deliverables: [
          'Brand Strategy Deck——30–40 页以上的战略文件（业务、市场、受众、定位、信息传达）',
          'Brand Strategy Map——整套战略体系浓缩于一页',
          'Creative Brief——后续设计、营销与传播决策的指南针',
          '业务诊断与市场趋势分析',
          '竞争对手分析，找出尚未被占据的战略位置',
          '受众细分与 JTBD 需求分析',
          '定位公式、价值主张与站得住脚的差异化',
        ...
        benefit: '营销、销售与设计朝同一个方向发力。4800 万苏姆买的不是一份提案，而是此后每一个品牌决策所依托的战略体系。',
        audience: '适合企业创始人、CEO、营销负责人，以及正在打造新品牌或进行品牌重塑的企业',
      },
      {
        id: 'naming',
        name: '命名',
