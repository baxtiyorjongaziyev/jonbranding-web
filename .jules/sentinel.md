...
**Prevention:** Use a hashing technique (e.g., SHA-256) combined with `crypto.timingSafeEqual` to compare strings without leaking their length or contents through timing side-channels.
